...
echo [2/3] Forwarding USB port and launching Satellite HUD on Xiaomi Phone...
adb forward tcp:8080 tcp:8080
adb shell am start -a android.intent.action.VIEW -d http://localhost:8080/satellite > nul 2>&1
